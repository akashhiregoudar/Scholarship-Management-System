...
if($_SESSION['usn']) {
    ...
    $usn=$_SESSION['usn'];
    $q="SELECT * FROM saibaba where usn='$usn'";
    $r=mysqli_query($db,$q);
    ...
    if($row['income']>=150001 and $row['pcm_percentage']>65) {
    ...
    if(isset($_POST['submit'])) {
        ...
        if($s1<100000 and $s2<100000 and $s3<100000) {
            ...
            if (move_uploaded_file($file1, $destination1) and move_uploaded_file($file2, $destination2) and move_uploaded_file($file3, $destination3)) {
                $query="INSERT INTO saibaba(usn,puc,incomedoc,signature) VALUES('$usn','$puc','$income','$signature')";
                if (!mysqli_query($db, $query)) {
                    echo "Error".mysqli_error($db);
                } else {
                    $q2="SELECT email FROM studentregister WHERE usn='$usn'";
                    $q3="SELECT app_no FROM saibaba WHERE usn='$usn'";
                    ...
                    <body>
                        ...
                        <div style='text-align: center; padding-left: 2rem; padding-right: 2rem;'>
                            ...
                            <h2>Sri Shirdi Saibaba Scholarship</h2>
...
<body>
    ...
    <div class="main">
        <h1 class="label">Sri Shirdi Saibaba Scholarship</h1>
        ...
        <table align="center">
            <tbody>
                ...
                <tr>
                <td> <label>Parents Income Certificate</label></td>
