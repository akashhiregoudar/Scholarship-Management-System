...
if($_SESSION['branch']) {
    ...
    $q="SELECT * FROM studentprofile INNER JOIN satish ON studentprofile.usn=satish.usn WHERE branch='$branch'";
    $r=mysqli_query($db,$q);
    if(!$r) {
        echo "Error ".mysqli_error($db);
    }
    ...
    if(isset($_POST['submit'])) {
      ...
      $q1="UPDATE satish SET remarks='$remark' WHERE usn='$usn'";
...
<meta charset="UTF-8">
    ...
    <title>Sri Satish Anand Scholarship</title>
</head>
<body>
  ...
  <?php if(mysqli_num_rows($r)>=1) { ?>
    <table class="table table-hover table-dark">
        <thead>
            ...
            <th scope="col" class="noExl">Profile Photo</th>
            <th scope="col" class="noExl">PUC markscard </th>
            <th scope="col" class="noExl">Previous sem markscard</th>
            <th scope="col" class="noExl">Previous sem markscard</th>
            <th scope="col" class="noExl">BPL Doc</th>
            <th scope="col" class="noExl">Signature</th>
        ...
        <?php While($row=mysqli_fetch_array($r)) { ?>
            ...
            <td class="noExl"><a href="../uploads/satish/<?php echo $row['puc'] ?>">Open Document</a></td>
            <td class="noExl"><a href="../uploads/satish/<?php echo $row['markscard1'] ?>">Open Document</a></td>
            <td class="noExl"><a href="../uploads/satish/<?php echo $row['markscard2'] ?>">Open Document</a></td>
            <td class="noExl"><a href="../uploads/satish/<?php echo $row['bpl'] ?>">Open Document</a></td>
            <td class="noExl"><a href="../uploads/satish/<?php echo $row['signature'] ?>">Open Document</a></td>
            <td class="noExl check">
                ...
                <table>
                  <tr>
                    ...
                    <select class="performance" name="performance">
                      <option value=""><?php ($row['remarks'] == NULL) ? print_r('SELECT') : print_r(explode(' ', $row['remarks'])[0]) ; ?></option>
                  ...
                  <tr>
                    ...
                    <select name="recommend">
                      <option value=""><?php ($row['remarks'] == NULL) ? print_r('SELECT') : print_r(explode(' ', $row['remarks'])[1]) ; ?></option>
...
<script type="text/javascript">
  $("#export").click(function(){
    ...
    $(".table").table2excel({
      exclude: ".noExl",
      name: "Satish Anand Scholarship",
      filename: "Satish Anand Scholarship"
    });
});
</script>
</body>
