...
if($_SESSION['username']) {
    ...
    $q="SELECT * FROM studentprofile INNER JOIN leadership ON studentprofile.usn=leadership.usn";
    $r=mysqli_query($db,$q);
    if(!$r) {
        echo "Error ".mysqli_error($db);
    }
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <h1>Mr Willium Mitchell Scholarship for demonstrated Leadership</h1>
...
<table class="table table-hover table-dark">
    <thead>
        ...
        <th class="noExl" scope="col">Document</th>
    ...
    <?php While($row=mysqli_fetch_array($r)) { ?>
        ...
        <td class="noExl"><a href="../uploads/leadership/<?php echo $row['puc'] ?>">Open Document</a></td>
        <td class="noExl"><a href="../uploads/leadership/<?php echo $row['document'] ?>">Open Document</a></td>
        <td class="noExl"><a href="../uploads/leadership/<?php echo $row['signature'] ?>">Open Document</a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
...
<script type="text/javascript">
  $("#export").click(function(){
    ...
    $(".table").table2excel({
      exclude: ".noExl",
      name: "Mr Willium Leadership",
      filename: "Mr Willium Leadership"
    });
});
</script>
</body>
