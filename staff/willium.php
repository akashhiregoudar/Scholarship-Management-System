...
if($_SESSION['username']) {
    ...
    $q="SELECT * FROM studentprofile INNER JOIN willium ON studentprofile.usn=willium.usn";
    $r=mysqli_query($db,$q);
    if(!$r) {
        echo "Error ".mysqli_error($db);
    }
...
<table class="table table-hover table-dark">
    <thead>
        ...
        <th class="noExl" scope="col">Caste Certificate</th>
    ...
    <?php While($row=mysqli_fetch_array($r)) { ?>
        ...
        <td class="noExl"><a href="../uploads/willium/<?php echo $row['puc'] ?>">Open Document</a></td>
        <td class="noExl"><a href="../uploads/willium/<?php echo $row['caste'] ?>">Open Document</a></td>
        <td class="noExl"><a href="../uploads/willium/<?php echo $row['markscard1'] ?>">Open Document</a></td>
        <td class="noExl"><a href="../uploads/willium/<?php echo $row['markscard2'] ?>">Open Document</a></td>
        <td class="noExl"><a href="../uploads/willium/<?php echo $row['signature'] ?>">Open Document</a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
