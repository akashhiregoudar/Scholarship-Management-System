...
if($_SESSION['username']) {
    ...
    $q="SELECT * FROM studentprofile INNER JOIN ramamoorthy ON studentprofile.usn=ramamoorthy.usn";
    $r=mysqli_query($db,$q);
    if(!$r) {
        echo "Error ".mysqli_error($db);
    }
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarText">
    ...
    <h1>Ramamoorthy Memorial Scholarship</h1>
...
<table class="table table-hover table-dark">
    ...
    <?php While($row=mysqli_fetch_array($r)) { ?>
        ...
        <td class="noExl"><a href="../uploads/ramamoorthy/<?php echo $row['puc'] ?>">Open Document</a></td>
        <td class="noExl"><a href="../uploads/ramamoorthy/<?php echo $row['incomedoc'] ?>">Open Document</a></td>
        <td class="noExl"><a href="../uploads/ramamoorthy/<?php echo $row['signature'] ?>">Open Document</a></td>
        </tr>
    <?php } ?>
    </tbody>
</table>
...
<script type="text/javascript">
  $("#export").click(function(){
    ...
    $(".table").table2excel({
      exclude: ".noExl",
      name: "Ramamoorthy Memorial",
      filename: "Ramamoorthy Memorial"
    });
});
</script>
</body>
